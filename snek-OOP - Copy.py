...
class Score:
    def __init__(self):
        ...
        self.quotes = ["The R is SUTD stands for rest", 
        "The S in ESD stands for sleep",
        "This is not a fact, this is a \n desperate cry for help :(",
        "The introduction of Python to \n the ecosystem has led to the \n extinction of Rhinos.",
        "Prof. Wong Wei Pin is quite handsome actually.",
        "Without U, SUTD is just STD."]
        ...
        if snake.head.distance(food.position) < 15: # calculate the distance between the two objects 
            ...
            if len(snake.segments) > 3:             # if the length of snake is longer than 3:
                ...
                if len(text.quotes[a]) > 30:
                    ...
                    text.newpen.goto(0, 180)
                    text.newpen.write(text.quotes[a], align="center", font=("Courier", 15, "normal"))
